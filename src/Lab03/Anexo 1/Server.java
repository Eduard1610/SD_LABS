...
public class Server {
    ...
    // constructor that receive the port to listen to for connection as
    // parameter
            ...
            for (int y = al.size(); --y >= 0;) {
                ...
                if (check.equals(tocheck)) {
                    ...
                    if (!ct1.writeMsg(messageLf)) {
                        al.remove(y);
                        display("Disconnected Client " + ct1.username
                            + " removed from list.");
                    }
    ...
    synchronized void remove(int id) {
        ...
        broadcast(
            notif + disconnectedClient + " has left the chat room." + notif);
    }
    /*
    ...
    class ClientThread extends Thread {
        ...
        ClientThread(Socket socket) {
            ...
            try {
                ...
                broadcast(
                    notif + username + " has joined the chat room." + notif);
            } catch (IOException e) {
